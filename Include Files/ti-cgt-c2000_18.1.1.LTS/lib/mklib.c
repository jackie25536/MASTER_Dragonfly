...
library_t LIBRARIES[] = {
    ...
    { "rts2800_fpu32_eabi.lib", { "C28EABI","CLA_MATH","GENERIC_MATH_COMMON_64BIT","GENERIC_MATH_COMMON","FPU32","GENERIC_MATH_COMMON_32BIT","EABI","GENERIC_MATH_COMMON_DOUBLE","GENERIC_MATH_COMMON_FLOAT" } },
    { "rts2800_ml_eabi_eh.lib", { "GENERIC_MATH_COMMON_64BIT","EABI_TDEH","LARGE","CLA_MATH","C28EABI","GENERIC_MATH_COMMON","EXCEPTIONS","EABI","GENERIC_MATH_COMMON_32BIT","GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON_DOUBLE" } },
    { "rts2800_fpu32_eabi_eh.lib", { "GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON_DOUBLE","EABI","FPU32","GENERIC_MATH_COMMON_32BIT","GENERIC_MATH_COMMON","EXCEPTIONS","GENERIC_MATH_COMMON_64BIT","EABI_TDEH","CLA_MATH","C28EABI" } },
    { "rts2800_fpu64_eabi_eh.lib", { "GENERIC_MATH_COMMON_DOUBLE","GENERIC_MATH_COMMON_FLOAT","FPU64","EABI","GENERIC_MATH_COMMON_32BIT","EXCEPTIONS","GENERIC_MATH_COMMON","CLA_MATH","C28EABI","EABI_TDEH","GENERIC_MATH_COMMON_64BIT" } },
    { "rts2800_ml.lib", { "LARGE" } },
    { "rts2800_fpu64_eabi.lib", { "CLA_MATH","C28EABI","GENERIC_MATH_COMMON_64BIT","GENERIC_MATH_COMMON","EABI","GENERIC_MATH_COMMON_32BIT","GENERIC_MATH_COMMON_DOUBLE","GENERIC_MATH_COMMON_FLOAT","FPU64" } },
    { "rts2800_fpu32.lib", { "FPU32" } },
    { "rts2800_ml_eabi.lib", { "EABI","GENERIC_MATH_COMMON_32BIT","GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON_DOUBLE","LARGE","GENERIC_MATH_COMMON_64BIT","CLA_MATH","C28EABI","GENERIC_MATH_COMMON" } },
    { "rts2800_fpu32_eh.lib", { "FPU32","FULL_PORTABLE_EH","EXCEPTIONS" } },
};

const char *DEFAULT_OPTIONS = " -O4 --diag_warning=225 --quiet";

const char *OBJ_SUBDIRS[] = { "libcxx","libcxx/ext","libcxx/include","libcxx/support/runtime","libcxx/support/ti","sys","xlocale" };
